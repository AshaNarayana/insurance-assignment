...
app.get('/user/:Id', getUserByIdRoute)
app.get('/user/userName', getUserByUserNameRoute)
app.get('/policy/userName', getPolicyByUserRoute)
app.get('/userInfo/policyNumber', getUserByPolicyRoute)
